  ...
  return client.chats.create(
      ...
      config=types.GenerateContentConfig(
          system_instruction=(
              ...
              '2. Call `query_pdf_with_gemini(query, page_number)` for the'
              ' relevant page. '
              '3. Do not loop or execute tool calls more than once per user'
              ' query. Return the answer based strictly on the document'
              ' content.'
          ),
